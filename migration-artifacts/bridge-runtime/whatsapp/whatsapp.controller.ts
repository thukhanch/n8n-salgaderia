...
export class WhatsappController {
  ...
  sendMessage(
    ...
    @Body() body: { to?: string; number?: string; text: string },
  ) {
    const destination = body.to || body.number || '';
    return this.whatsappService.sendMessage(sessionId, destination, body.text);
  }
